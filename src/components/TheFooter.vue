    ...
    <div class="footer-inner">
      ...
      <ul class="footer-list">
        <li class="footer-list-block">
          <h4 class="list-block-title">Features</h4>
          <ul>
        ...
        <li class="footer-list-block">
          <h4 class="list-block-title">Resources</h4>
          <ul>
            <li>Blog</li>
            <li>Developers</li>
            <li>Support</li>
        ...
        <li class="footer-list-block">
          <h4 class="list-block-title">Compagny</h4>
          <ul>
            <li>About</li>
            <li>Out Team</li>
            <li>Careers</li>
...
.footer-inner {
  width: $width_inner;
  padding-block: clamp(50px, calc(3.125rem + ((1vw - 3.75px) * 3.2415)), 70px);
...
.footer-list {
  ...
  .footer-list-block {
    ...
    li {
      margin-bottom: 8px;
      @include link-hover(color, $a_text_color_hover);
    }
  }
}
...
.footer-social ul {
  ...
  li {
    path {
      @include link-hover(fill, $a_text_color_hover);
    }
  }
}
